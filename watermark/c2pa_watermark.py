...
def build_manifest(watermarkID, img_in):
       ...
       actions=[]
       created_act=dict()
       created_act['action']='c2pa.created'
       created_act['softwareAgent'] = dict()
       created_act['softwareAgent']['name'] = "GPT-4o"
       created_act['digitalSourceType'] = "http://cv.iptc.org/newscodes/digitalsourcetype/trainedAlgorithmicMedia"
       actions.append(created_act)
       act=dict()
...
def main() :
   ...
   img_in='figma.png'
   img_out='figma_wm.png'
   img_out_signed='figma_wm_signed.png'
